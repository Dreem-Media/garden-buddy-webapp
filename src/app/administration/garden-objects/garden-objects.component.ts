...
import { GardenObjectSuggestion } from 'src/app/_models/_core/_garden/garden-object-suggestion.model';
...
export class GardenObjectsComponent implements OnInit {
  ...
  public displayedColumnsSuggestions: string[] = [
    'name',
    'description',
    'edit',
  ];
